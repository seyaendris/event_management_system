...
const EventDetails = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  return (
    <>
    <section className="flex justify-center bg-orange-50 bg-dotted-pattern bg-contain">
      <div className="grid grid-cols-1 md:flex md:flex-col 2xl:max-w-7xl md:wrapper">
        ...
        <Image 
          ...
          width={1500}
          height={1000}
          className="min-h-[300px] h- object-cover object-center rounded-3xl p-3 transition ease-in-out delay-100  hover:-translate-y-1 hover:scale-95 duration-200"
        />
        ...
        <div className="flex grow w-full flex-col gap-8 p-5 md:p-10">
          <div className="flex flex-col gap-6">
            ...
            <p className="p-medium-18 mt-2 sm:mt-0">
                By{' '}
                <span className="text-orange-900 font-bold">{event.organizer.firstName} {event.organizer.lastName}</span>
              </p>
              ...
              <div className="flex gap-3 flex-col md:flex-row">
                ...
                {event.isVip && (
                  <p className="p-bold-20 rounded-lg bg-yellow-600/10 px-5 py-2 text-yellow-700">
                    Vip Price: ${event.vipPrice}
                  </p>
                )}
              </div>
        </div>
        ...
        <div className='flex gap-2 md:gap-3'>
            ...
            <div className="p-medium-16 lg:p-regular-20 flex flex-wrap items-center md:flex md:flex-col">
            <p>
